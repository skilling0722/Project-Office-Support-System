...
class View_Alarm_Memo(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("background-color: #DACEFF")
        self.center()

        self.title = QLineEdit(self)
        self.title.setGeometry(QtCore.QRect(15,30,320, 30))
        self.title.setStyleSheet("background-color: #21004C; color: white; border-style: outset; border-radius: 5px; border-width: 2px")
        ...
        self.time.setGeometry(QtCore.QRect(15,60,320, 30))
        self.time.setStyleSheet("background-color: #E8CCFF; color: black; border-style: outset; border-radius: 5px; border-width: 2px")
        self.time.setFont(title_font)
        self.time.setAlignment(QtCore.Qt.AlignCenter)
        
        self.memo_window = QTextEdit(self)
        self.memo_window.setReadOnly(True)
        self.memo_window.setGeometry(QtCore.QRect(10,90,330, 260))
    ...
    def memo_time(self, timee):
        self.time.setText(str(timee))
